...
/**
 *  Abstract class for IIrcEventHandler.
 *  Some methods are abstract as every IRC client must implement them (I think).
 * 
 *  @author Ondrej Zizka, ozizka at redhat.com
 */
public abstract class IrcEventHandlerBase implements IIrcEventHandler {

    @Override public abstract void onVersion(String sourceNick, String sourceLogin, String sourceHostname, String target);

    @Override public abstract void onPing(String sourceNick, String sourceLogin, String sourceHostname, String target, String pingValue);

    @Override public abstract void onServerPing(String response);

    @Override public abstract void onTime(String sourceNick, String sourceLogin, String sourceHostname, String target);

    @Override public abstract void onFinger(String sourceNick, String sourceLogin, String sourceHostname, String target);
    ...
    @Override public void onServerResponse(int code, String response) {}
    ...
    @Override public void onTopic(String channel, String topic) {}
