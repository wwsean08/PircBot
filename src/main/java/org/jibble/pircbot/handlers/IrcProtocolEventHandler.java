...
/**
 * Default implementation of IRC event handler, which reacts to basic IRC
 * protocol events like PING.
 * 
 * @author Ondrej Zizka, ozizka at redhat.com
 */
public class IrcProtocolEventHandler implements IIrcServerCommHandler
{
